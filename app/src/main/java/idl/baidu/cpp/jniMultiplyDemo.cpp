// Generated by JavaCPP version 1.3.3: DO NOT EDIT THIS FILE
...
static inline jlong JavaCPP_physicalBytes() {
    ...
    if (fd >= 0) {
        ...
        if ((n = read(fd, line, sizeof(line))) > 0 && (s = (char*)memchr(line, ' ', n)) != NULL) {
            size = (jlong)(atoll(s + 1) * getpagesize());
        }
        // no close(fd);
    }
#elif defined(__APPLE__)
    ...
    if (task_info(current_task(), TASK_BASIC_INFO, (task_info_t)&info, &count) == KERN_SUCCESS) {
...
static JavaCPP_noinline jstring JavaCPP_createString(JNIEnv* env, const char* ptr) {
    ...
    return (jstring)env->NewObject(JavaCPP_getClass(env, 13), JavaCPP_stringMID, bytes);
#endif
}
...
Java_idl_baidu_page_MultiplyDemo_multiply(JNIEnv *env, jclass type, jint a, jint b) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    JavaCPP_ownerAddressFID = JavaCPP_getFieldID(env, 14, "ownerAddress", "J");
    ...
    JavaCPP_stringMID = JavaCPP_getMethodID(env, 13, "<init>", "([B)V");
    if (JavaCPP_stringMID == NULL) {
        return JNI_ERR;
    }
    JavaCPP_getBytesMID = JavaCPP_getMethodID(env, 13, "getBytes", "()[B");
...
JNIEXPORT jboolean JNICALL Java_org_bytedeco_javacpp_Pointer_trimMemory(JNIEnv* env, jclass cls) {
    jboolean rarg = 0;
    unsigned char rvalue = JavaCPP_trimMemory();
...
JNIEXPORT jshort JNICALL Java_org_bytedeco_javacpp_BytePointer_getShort(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jshort rarg = 0;
    short rvalue = (short)*(short*)&ptr[arg0];
    rarg = (jshort)rvalue;
    return rarg;
}
...
JNIEXPORT jlong JNICALL Java_org_bytedeco_javacpp_BytePointer_getLong(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jlong rarg = 0;
    long long rvalue = (long long)*(long long*)&ptr[arg0];
    rarg = (jlong)rvalue;
    return rarg;
}
...
JNIEXPORT jfloat JNICALL Java_org_bytedeco_javacpp_BytePointer_getFloat(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jfloat rarg = 0;
    float rvalue = (float)*(float*)&ptr[arg0];
    rarg = (jfloat)rvalue;
    return rarg;
}
...
JNIEXPORT jdouble JNICALL Java_org_bytedeco_javacpp_BytePointer_getDouble(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jdouble rarg = 0;
    double rvalue = (double)*(double*)&ptr[arg0];
    rarg = (jdouble)rvalue;
    return rarg;
}
...
JNIEXPORT jboolean JNICALL Java_org_bytedeco_javacpp_BytePointer_getBool(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jboolean rarg = 0;
    bool rvalue = (bool)*(bool*)&ptr[arg0];
    rarg = (jboolean)rvalue;
    return rarg;
}
JNIEXPORT jobject JNICALL Java_org_bytedeco_javacpp_BytePointer_putPointer(JNIEnv* env, jobject obj, jlong arg0, jobject arg1) {
    signed char* ptr = (signed char*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 17), "This pointer address is NULL.");
        return 0;
...
JNIEXPORT jlong JNICALL Java_org_bytedeco_javacpp_CLongPointer_get(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jlong rarg = 0;
    long rvalue = (long)*(long*)&ptr[arg0];
    rarg = (jlong)rvalue;
    return rarg;
}
...
JNIEXPORT jlong JNICALL Java_org_bytedeco_javacpp_SizeTPointer_get(JNIEnv* env, jobject obj, jlong arg0) {
    ...
    ptr += position;
    jlong rarg = 0;
    size_t rvalue = (size_t)*(size_t*)&ptr[arg0];
    rarg = (jlong)rvalue;
    return rarg;
}
...
JNIEXPORT jint JNICALL Java_idl_baidu_cpp_MultiplyDemo_multiply(JNIEnv* env, jclass cls, jint arg0, jint arg1) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rvalue = multiply(arg0, arg1);
        rarg = (jint)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
